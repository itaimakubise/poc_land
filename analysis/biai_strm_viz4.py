...
def load_data():
    ...
    # 6. Comprehensive Cost (Ensure numeric)
...
with tab3:
    ...
    with c2:
        ...
        risk_idx = df.groupby('rpt_street_name').agg({'ID':'count', 'Estimated Total Comprehensive Cost':'sum'}).nlargest(10, 'ID').reset_index()
...
# TAB 4: FINANCIAL & VRU IMPACT (THE BEEFED UP SECTION)
with tab4:
    st.subheader("Economic Drain & Vulnerable User Strain")
    f_col1, f_col2 = st.columns(2)
    
    with f_col1:
        # Cost by Severity Breakdown
